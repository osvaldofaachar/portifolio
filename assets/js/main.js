...
//email
// Adicione este script ao final da página ou em um arquivo JS separado
// Substitua pela sua Public API Key
emailjs.init("tgghCIvn5yjKLtqiF");

document.getElementById('contact-form').addEventListener('submit', function (event) {
  event.preventDefault(); // Impede o envio padrão do formulário


  emailjs.send("service_lyohlru", "template_f1ss9fb", {
